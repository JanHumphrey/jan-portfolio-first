    ...
    <>
      ...
      <section>
        ...
        <div className="px-6 lg:px-[179px]">
          ...
          <div className="flex flex-col lg:flex-row lg:mt-[212px] lg:gap-36">
            <div className="order-1 font-main font-bold text-xs mt-32 lg:order-2 lg:mt-[80px]">
              ...
              <div className="hidden md:block order-2 mt-6 lg:order-3">
                <h1 className='font-main2 text-4xl font-bold 2xl:ml-10 lg:text-5xl'>Technology Stack <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
              ...
              <div className="hidden md:block order-3 lg:order-4">
                <h1 className='font-main2 text-4xl font-bold 2xl:ml-10 lg:text-5xl'>Recommendations <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
            ...
            <div className="order-4 flex flex-col mt-6 space-y-8 lg:order-1">
              ...
              <div>
                ...
                <h1 className='font-main2 text-4xl font-bold 2xl:ml-10 lg:text-5xl mb-2'>Contact <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
              ...
              <div>
                <h1 className='font-main2 text-4xl font-bold 2xl:ml-10 lg:text-5xl mb-2'>Hire Me <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
                <p className="font-main2">Book a zero-cost <a>consultation</a> with me and let's have a conversation about your project.</p>
              </div>
              <div>
                <h1 className='font-main2 text-4xl font-bold 2xl:ml-10 lg:text-5xl mb-2'>Social Links <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
          ...
          <div className="block md:hidden order-2 mt-6">
            <h1 className='font-main2 text-4xl font-bold 2xl:ml-10'>Technology Stack <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
            {/* STACK COMPONENTS HERE */}
            <div>
          ...
          <div className="block md:hidden order-3">
            <h1 className='font-main2 text-4xl font-bold 2xl:ml-10'>Recommendations <span className='inline-block w-3 h-3 bg-violet-500 rounded-full'></span></h1>
            {/* RECOMMENDATIONS COMPONENTS HERE */}
            <div>
            </div>
          </div>
